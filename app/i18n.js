...
(function (global) {
  ...
  'stats.none':'Outside a ranked area — the model scores the raster here but did not cluster it into a focus area.',
      ...
      'setup.aoiPick': "Which shape",
      'setup.aoiDraw': "Draw an area on the map",
      'setup.aoiNone': "Nothing drawn yet. Use the Area tool to draw the boundary on the map, then come back — it will be listed here.",
  ...
  'stats.none':'Hors d’un secteur classé — le modèle évalue le raster ici mais ne l’a pas regroupé en secteur prioritaire.',
      ...
      'setup.aoiPick': "Quelle forme",
      'setup.aoiDraw': "Dessiner une zone sur la carte",
      'setup.aoiNone': "Rien de dessiné pour l'instant. Utilisez l'outil Zone pour tracer la limite sur la carte, puis revenez ici — elle apparaîtra dans la liste.",
