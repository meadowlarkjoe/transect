...
(function (global) {
  ...
  'stats.none':'Outside a ranked area — the model scores the raster here but did not cluster it into a focus area.',
      ...
      'setup.aoiRadius': "Radius",
      'setup.aoiYours': 'Your boundary',
      'setup.aoiClear': 'Remove it',
      'setup.aoiEdit': 'Edit',
      'setup.aoiRedraw': 'Redraw the boundary',
      'setup.aoiDraw': 'Draw the boundary on the map',
      'setup.aoiNone2': 'Draw the boundary on the map — click each corner, double-click to close. You stay on this page while you do it.',
      'draw.minVerts': 'A shape needs at least three corners.',
      'draw.minVerts2': 'A line needs at least two points.',
      'setup.aoiDrawn': "Drawn area",
      'setup.aoiPad': "The model looks 2.5 km past your boundary — the road you get in on, and the lakes that make a funnel, are usually outside the line — and reports only what falls inside it.",
      ...
      'lay.funnel': 'Funnels / passes', 'lay.funnel.n': 'A neck that travel is FORCED through — it must separate two real pieces of ground (a peninsula is narrow but leads nowhere) and join two places worth moving between, ideally feed on one side and cover on the other.',
      ...
      'lay.water': 'Water', 'lay.water.n': 'Everything wet, most specific first: a beaver pond is a beaver pond, not a generic waterbody.',
      'lay.brRegenPrime': "Regen — prime (10–25 yr)", 'lay.brRegenPrime.n': "Willow, birch and aspen at moose height with cover alongside. The money browse.",
      'lay.brAquatic': "Aquatic & riparian", 'lay.brAquatic.n': "Alder edges plus emergent and submergent aquatics — sodium-rich feeding, dawn and dusk.",
      'lay.brRegenClosing': "Regen — closing in (26–40 yr)", 'lay.brRegenClosing.n': "Growing out of reach as the canopy closes. Still worth hunting at the edges.",
      'lay.brDeciduous': "Deciduous & mixed stand", 'lay.brDeciduous.n': "Hardwood browse mapped by survey rather than inferred. The stand map has classes, not species.",
      'lay.brRegenNew': "Regen — new (<10 yr)", 'lay.brRegenNew.n': "Below reachable height with no security cover yet. Open ground, not a feeding area.",
      'lay.brOther': "Other forage", 'lay.brOther.n': "Scores as browse, but nothing dated or surveyed says what stage it is at — a land-cover read.",
      'lay.browse': "Browse / feeding", 'lay.browse.n': "What there is to eat, and what stage it is at.",
      'lay.stands': "Forest survey",
      'stands.unsaved': "Save this plan and the forest survey loads with it — it is too big to carry inside the plan itself.",
      'lay.stands.n': "Every mapped stand, shaded by what its species are worth to a moose. Dark = conifer cover, bright = birch and aspen. Amber outline = a dated cut or burn.",
      'lay.openwater': 'Rivers & lakes', 'lay.openwater.n': 'Mapped hydrography (OSM) — the general case, and the one the other two outrank.',
      ...
      'lay.modeRide': 'Ridden (ATV/SxS)', 'lay.modeRide.n': 'Road and motorised sentier you ride. The machine starts where you do and stays where you step off it — you come back to it.',
      'lay.modeBoat': 'On the water', 'lay.modeBoat.n': 'Paddled or run under power. A motorboat launches only where a drivable road meets water; a canoe can be portaged in.',
      'lay.modeTrail': 'Walked — trail', 'lay.modeTrail.n': 'On foot along a road or cut line. Quiet, fast, and where moose travel too.',
      'lay.modePortage': 'Portage', 'lay.modePortage.n': 'Carrying between road and water. The worst ground on any route — in with a canoe, out with the canoe AND the meat, several trips over the same yards.',
      'lay.modeBush': 'Walked — bushwhack', 'lay.modeBush.n': 'On foot off any line. This is the part you repeat carrying meat, so it is the number that matters on a pack-out.',
  ...
  'stats.none':'Hors d’un secteur classé — le modèle évalue le raster ici mais ne l’a pas regroupé en secteur prioritaire.',
      ...
      'setup.aoiRadius': "Rayon",
      'setup.aoiYours': 'Votre limite',
      'setup.aoiClear': 'Retirer',
      'setup.aoiEdit': 'Modifier',
      'setup.aoiRedraw': 'Redessiner la limite',
      'setup.aoiDraw': 'Dessiner la limite sur la carte',
      'setup.aoiNone2': 'Dessinez la limite sur la carte — cliquez chaque coin, double-cliquez pour fermer. Vous restez sur cette page pendant ce temps.',
      'draw.minVerts': 'Une forme doit avoir au moins trois coins.',
      'draw.minVerts2': 'Une ligne doit avoir au moins deux points.',
      'setup.aoiDrawn': "Zone dessinée",
      'setup.aoiPad': "Le modèle regarde 2,5 km au-delà de votre limite — le chemin d'accès et les lacs qui forment un corridor sont presque toujours à l'extérieur du tracé — et ne rapporte que ce qui tombe à l'intérieur.",
      ...
      'lay.funnel': 'Corridors / cols', 'lay.funnel.n': 'Un goulot que le déplacement est FORCÉ d’emprunter — il doit séparer deux véritables masses de terrain (une presqu’île est étroite mais ne mène nulle part) et relier deux endroits qui valent le déplacement, idéalement la nourriture d’un côté et le couvert de l’autre.',
      ...
      'lay.water': 'Eau', 'lay.water.n': 'Tout ce qui est humide, du plus précis au plus général : un étang de castor n\'est pas un plan d\'eau générique.',
      'lay.brRegenPrime': "Régénération — optimale (10–25 ans)", 'lay.brRegenPrime.n': "Saule, bouleau et peuplier à hauteur d'orignal avec du couvert à côté. La nourriture qui compte.",
      'lay.brAquatic': "Aquatique et riverain", 'lay.brAquatic.n': "Bordures d'aulnes et plantes aquatiques — alimentation riche en sodium, à l'aube et au crépuscule.",
      'lay.brRegenClosing': "Régénération — se referme (26–40 ans)", 'lay.brRegenClosing.n': "Hors de portée à mesure que le couvert se referme. Encore valable en bordure.",
      'lay.brDeciduous': "Peuplement feuillu et mélangé", 'lay.brDeciduous.n': "Broutage feuillu relevé par inventaire. La carte des peuplements donne des classes, pas des espèces.",
      'lay.brRegenNew': "Régénération — récente (<10 ans)", 'lay.brRegenNew.n': "Sous la hauteur de broutage, sans couvert de sécurité. Terrain ouvert, pas une aire d'alimentation.",
      'lay.brOther': "Autre nourriture", 'lay.brOther.n': "Compte comme broutage, mais rien de daté ni d'inventorié n'en précise le stade — une lecture de couverture du sol.",
      'lay.browse': "Broutage / alimentation", 'lay.browse.n': "Ce qu'il y a à manger, et à quel stade.",
      'lay.stands': "Inventaire forestier",
      'stands.unsaved': "Enregistrez ce plan et l'inventaire forestier se chargera avec lui — il est trop volumineux pour tenir dans le plan.",
      'lay.stands.n': "Chaque peuplement cartographié, teinté selon la valeur de ses essences pour l'orignal. Foncé = couvert résineux, clair = bouleau et peuplier. Contour ambre = coupe ou brûlis daté.",
      'lay.openwater': 'Rivières et lacs', 'lay.openwater.n': 'Hydrographie cartographiée (OSM) — le cas général, que les deux autres devancent.',
      ...
      'lay.modeRide': 'En VTT / côte-à-côte', 'lay.modeRide.n': 'Chemin et sentier motorisé que vous roulez. La machine part d’où vous partez et reste là où vous en descendez — vous y revenez.',
      'lay.modeBoat': 'Sur l’eau', 'lay.modeBoat.n': 'À la pagaie ou au moteur. Un bateau à moteur ne se met à l’eau que là où un chemin carrossable touche l’eau; un canot peut être porté.',
      'lay.modeTrail': 'À pied — sentier', 'lay.modeTrail.n': 'À pied sur un chemin ou une ligne coupée. Silencieux, rapide, et emprunté par l’orignal aussi.',
      'lay.modePortage': 'Portage', 'lay.modePortage.n': 'Portage entre le chemin et l’eau. Le pire terrain d’un trajet — à l’aller le canot, au retour le canot ET la viande, plusieurs voyages sur les mêmes mètres.',
      'lay.modeBush': 'À pied — hors sentier', 'lay.modeBush.n': 'À pied hors de toute ligne. C’est la portion que vous refaites chargé de viande — le chiffre qui compte pour la sortie.',
